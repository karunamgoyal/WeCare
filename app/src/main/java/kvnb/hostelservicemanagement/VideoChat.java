...
public class VideoChat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        channel = getIntent().getExtras().getString("doctor");
    ...
    private void setupSession() {
        ...
        mRtcEngine.setVideoEncoderConfiguration(new VideoEncoderConfiguration(VideoEncoderConfiguration.VD_960x720, VideoEncoderConfiguration.FRAME_RATE.FRAME_RATE_FPS_30,
    ...
    public void onjoinChannelClicked(View view) {
        mRtcEngine.joinChannel(null, channel, "Extra Optional Data", 0); // if you do not specify the uid, Agora will assign one.
        setupLocalVideoFeed();
